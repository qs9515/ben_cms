...
use core\log;
use PDO;
class dao_mysql implements db_abstract
{
    //当前数据库连接
    ...
    {
        $this->_dao_conn=mysql_connect::getInstance($host);
    ...
    public function select($invoke=true)
    {
        ...
        {
            $tempLimitNumber=$this->_dao_limit_number;
     ...
     * @throws \Exception
     */
    private function mysql_query($query_string,$params=array())
    {
    ...
    public function query($query_string,$params=array())
    {
        ...
        $this->_dao_rs=$this->mysql_query($query_string,$params);
    }
    ...
    public function insert()
    {
        ...
        {
            $nums=$sth->rowCount();
            $this->_last_insert_id=$this->_dao_conn->lastInsertId();
            //释放游标
            $sth->closeCursor();
            return $nums;
        }
